...
Понял вас. Исправил verbatim на Verbatim и постарался убрать лишние пустые строки в фрагментах кода.

Вот обновленная версия раздела:
...
Управление схемой базы данных и ее миграциями осуществляется с помощью Liquibase. Изменения схемы описываются в XML или YAML файлах (ченджлогах), что обеспечивает версионирование и контролируемое обновление структуры БД. Пример ченджлога для создания таблицы категорий:
